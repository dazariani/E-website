  ...
  return (
    <Wrapper>
      <Container>
        ...
        <LogoNavBox>
          <LogoBox>
            <Logo src="/assets/shared/desktop/logo.svg" />
          </LogoBox>
...
const Content = styled.p`
  ...
  line-height: 25px;
`;
const CopyrightSocialBox = styled.div`
  display: flex;
  flex-direction: column;
  align-items: center;
`;
...
const SocialBox = styled.div`
  ...
  gap: 20px;
`;
const SocialLogo1 = styled.svg`
  /* &:hover > path {
    fill: red;
  } */
`;
const SocialLogo2 = styled(SocialLogo1)``;
const SocialLogo3 = styled(SocialLogo1)``;
