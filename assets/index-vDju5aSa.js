...
`;function r4(e){const{setShowThanks:t,cardData:n,grandTotal:r,showThanks:i}=e,[o,s]=N.useState(!1),a=()=>o?n:n.filter((c,f)=>f==0);return u.jsx(Rk,{$showThanks:i,children:u.jsxs(Dk,{children:[u.jsxs(Ak,{children:[u.jsx(Fk,{src:"/assets/checkout/icon-order-confirmation.svg"}),u.jsx(Mk,{children:"THANK YOU FOR YOUR ORDER"}),u.jsx(Bk,{children:"You will receive an email confirmation shortly."})]}),u.jsxs(Uk,{children:[u.jsxs(Kk,{children:[a().map(l=>u.jsxs(Vk,{children:[u.jsxs(Wk,{children:[u.jsx(Xk,{children:u.jsx(Hk,{src:l.image.mobile})}),u.jsxs(Qk,{children:[u.jsx(Gk,{children:l.cartName}),u.jsx(Yk,{children:"$ "+l.price})]})]}),u.jsx(qk,{children:"x"+l.NumberOfItems})]})),u.jsx(Zk,{onClick:()=>s(!o),children:o?"View less":`and ${n.length-1} other item(s)`})]}),u.jsxs(Jk,{children:[u.jsx(e4,{children:"GRAND TOTAL"}),u.jsx(t4,{children:"$ "+r})]})]}),u.jsx(Le,{to:"/",target:"_top",onClick:()=>t(!1),children:u.jsx(n4,{children:"BACK TO HOME"})})]})})}const i4=Lt.filter(e=>e.category=="headphones").reverse(),o4=Lt.filter(e=>e.category=="speakers").reverse(),s4=Lt.filter(e=>e.category=="earphones").reverse(),a4=Lt.filter(e=>e.name.toLowerCase()=="XX99 Mark II Headphones".toLowerCase()),l4=Lt.filter(e=>e.name.toLowerCase()=="XX99 Mark I Headphones".toLowerCase()),u4=Lt.filter(e=>e.name.toLowerCase()=="XX59 Headphones".toLowerCase()),c4=Lt.filter(e=>e.name.toLowerCase()=="ZX9 SPEAKER".toLowerCase()),d4=Lt.filter(e=>e.name.toLowerCase()=="ZX7 SPEAKER".toLowerCase()),p4=Lt.filter(e=>e.name.toLowerCase()=="YX1 WIRELESS EARPHONES".toLowerCase());var f4={};const h4={darkOrange:"rgb(216, 125, 74)",lightOrange:"rgb(251, 175, 133)",dark:"rgb(16, 16, 16)",black:"rgb(0, 0, 0)",darkGrey:"rgb(241, 241, 241)",lightGrey:"rgb(250, 250, 250)",white:"rgb(255, 255, 255)"},m4=()=>{let e=localStorage.getItem("cardList");return e?JSON.parse(e):[]};function g4(){const[e,t]=N.useState(m4()),[n,r]=N.useState(!1),[i,o]=N.useState(!1),[s,a]=N.useState(!1),[l,c]=N.useState(0);return N.useEffect(()=>{localStorage.setItem("cardList",JSON.stringify(e))},[e]),u.jsx(u.Fragment,{children:u.jsxs(C0,{theme:h4,children:[u.jsxs(B0,{children:[u.jsx("link",{rel:"preconnect",href:"https://fonts.googleapis.com"}),u.jsx("link",{rel:"preconnect",href:"https://fonts.gstatic.com"}),u.jsx("link",{href:"https://fonts.googleapis.com/css2?family=Manrope:wght@300;500;700&display=swap",rel:"stylesheet"})]}),u.jsx(b0,{}),u.jsxs(Uy,{basename:f4.REACT_APP_URI,children:[e.length>0&&u.jsx(r4,{grandTotal:l,showThanks:s,setShowThanks:a,cardData:e}),u.jsx(Qw,{cardData:e,setCardData:t,showCart:n,setShowCart:r}),u.jsx(Yw,{showThanks:s,showCart:n,showNavList:i}),u.jsxs(x4,{children:[u.jsx(Jy,{showCart:n,setShowCart:r,showNavList:i,setShowNavList:o}),u.jsx(Lk,{showNavList:i}),u.jsxs(Ry,{children:[u.jsx(it,{path:"/",element:u.jsx(J1,{designData:Lt})}),u.jsx(it,{path:"/checkout",element:u.jsx(Ik,{cardData:e,setCardData:t,setGrandTotal:c,setShowThanks:a})}),u.jsx(it,{path:"/category-headphones",element:u.jsx(ma,{productsData:i4})}),u.jsx(it,{path:"/category-speakers",element:u.jsx(ma,{productsData:o4})}),u.jsx(it,{path:"/category-earphones",element:u.jsx(ma,{productsData:s4})}),u.jsx(it,{path:"/product-mark2",element:u.jsx(Zn,{cardData:e,setCardData:t,detailData:a4})}),u.jsx(it,{path:"/product-mark1",element:u.jsx(Zn,{cardData:e,setCardData:t,detailData:l4})}),u.jsx(it,{path:"/product-XX59",element:u.jsx(Zn,{cardData:e,setCardData:t,detailData:u4})}),u.jsx(it,{path:"/product-ZX9",element:u.jsx(Zn,{cardData:e,setCardData:t,detailData:c4})}),u.jsx(it,{path:"/product-ZX7",element:u.jsx(Zn,{cardData:e,setCardData:t,detailData:d4})}),u.jsx(it,{path:"/product-YX1",element:u.jsx(Zn,{cardData:e,setCardData:t,detailData:p4})})]}),u.jsx(fv,{})]})]})]})})}const x4=x.div``,y4=ja.createRoot(document.getElementById("root"));y4.render(u.jsx(G.StrictMode,{children:u.jsx(g4,{})}));
